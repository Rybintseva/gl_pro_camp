...
class TestApi:
    ...
    def test_login_invalid_password(self):
        with allure.step('Login to the site with invalid password'):
            self.api.post_login(HEADERS_INVALID, UN_AUTH)

    @allure.story('Get files from root folder')
    def test_get_files_from_root_folder(self, token):
    ...
    @allure.story('Get files from specific folder')
    def test_get_files_from_specific_folder(self, token):
